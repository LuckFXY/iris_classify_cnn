...
#IMAGE_SIZE=106 is defined in reader.py
 
#===========================LeNet-5 demo================================
def evaluate_lenet(datasets,params,skip_training,apply_set_namelist,
                    n_epochs=500,learning_rate=0.0003,
                    nkerns=[20,40,60],batch_size=60):#500
    '''
    ...
    CP0=LeNetConvPoolLayer(        
        input=CP0_input,
        rng=rng,
        image_shape=(batch_size,1,MR.IMAGE_SIZE,MR.IMAGE_SIZE),
